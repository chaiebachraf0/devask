...
const routes: Routes = [
  ...
  children:[
   ...
   {path:'inventaire/detailsinv/:id',component:InvdetailsComponent},
   ...
   {path:'achat/commf/commDetails/:id',component:CommdetailsComponent},
   {path:'achat/commf/editcomm/:id',component:EditcommcComponent},
